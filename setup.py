...
setup(
    name=name,  # Required
    version=get_version("d2.py".format(name)),  # Required
    # This is a one-line description or tagline of what your project does.
    description="CLI to get API JSON data and show as table",  # Required
    long_description=long_description,  # Optional
    long_description_content_type="text/markdown",  # Optional
    install_requires=install_requires,
    py_modules=["d2"],
    entry_points={"console_scripts": ["d2=d2:main"]},  # Optional
    url=gh_repo,  # Optional
    author="weaming",  # Optional
    author_email="garden.yuen@gmail.com",  # Optional
    keywords="tools,api",  # Optional
